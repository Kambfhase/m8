YUI({
    ...
    var basics = new Y.Test.Case({
        ...
        testCreation: function(){
            ...
            Y.ArrayAssert.itemsAreEqual2D( [2,2,2,2,2], Vector( [2,2,2,2,2]));
            // Vector.create()
    ...
    var maths = new Y.Test.Case({
        ...
        testScale: function(){
            ...
            Y.Assert.isTrue( Vector( [2]).scale(1/2).equals(Vector([1])));
        ...
        testMagnitude: function(){
            ...
            Y.Assert.areSame( Math.SQRT2, Vector([1,1]).magnitude());
        },
        ...
        testNormalize: function(){
            ...
            Y.Assert.isTrue( Vector([1,1]).normalize().equals([ Math.pow( 2,.5)/2,Math.SQRT2/2]));
